...
public class ChooseCustomerPopup extends PopupWindow {
    ...
    private ArrayList<AccountObject> listData;
    private ChooseCustomerAdapter adapter;
    private ChooseCustomerAdapter.ItemListener itemListener;

    public ChooseCustomerPopup(Context context, ArrayList<AccountObject> listData, ChooseCustomerAdapter.ItemListener itemListener) {
