...
public class ProcessStartWithDauDB {
    public static void processStartWithTypeDauDB(StringProcessEntity processEntity, StringProcessChildEntity childEntity, List<String> listWord, AccountObject customer, StringProcessChildEntity previousEntity,int position) {
        try {
                                    ...
                                    for (int i = 1; i < listWord.size() - 2; i++) { //Lấy các cặp số
                                        ...
                                        if (patternNumber.matcher(word).matches()) { //Nếu từ là số
                                            if (word.length() == 1 || word.length() > 4) {
                                                setError(processEntity, childEntity, "Đầu ĐB phải là các cặp số:01 02 03...232 sẽ hiểu là 23 và 32. 2345 sẽ hiểu là 23 và 45");
                                                isError = true;
                                                break;
                                                        ...
                                                        if (i + 2 >= listWord.size() - 2) {
                                                            ...
                                                            for (int j = i + 2; j < listWord.size() - 2; j++) { //duyệt các từ sau
                                                                ...
                                                                if (patternNumber.matcher(wordAfter2).matches()) { //Nếu là số
                                                                    if (wordAfter2.length() > 1) { //Nếu là số có từ 2 chữ số trở lên
                                                                        isError = true;
                                                                        setError(processEntity, childEntity, "Sau đít không thể là Đầu ĐB nữa\n-đít1 2 3 hoặc đít1.2.3 hoặc đít123 được hiểu là đít1 đít2 đít3");
                                                                        break;
                                                                    } else { //Nếu là số có 1 chữ số
                                                                        wordAfter1 = wordAfter1 + wordAfter2;
                                                                        if (!checkValidateRepeatChar(wordAfter1)) {
                                                                            isError = true;
                                                                            setError(processEntity, childEntity, "Các số trong Đầu, Đuôi, Tổng không được trùng nhau. Ví dụ: Đầu ĐB đầu 2345 x 10n");
                                                                            break;
                                                                        }
                                                                    }
                                                                } else { // nếu là chữ
                                                        ...
                                                        if (i + 2 >= listWord.size() - 2) {
                                                            ...
                                                            for (int j = i + 2; j < listWord.size() - 2; j++) { //duyệt các từ sau
                                                                ...
                                                                if (patternNumber.matcher(wordAfter2).matches()) { //Nếu là số
                                                                    if (wordAfter2.length() > 1) { //Nếu là số có từ 2 chữ số trở lên
                                                                        isError = true;
                                                                        setError(processEntity, childEntity, "Sau đầu không thể là Đầu ĐB nữa\n-đầu1 2 3 hoặc đầu1.2.3 hoặc đầu123 được hiểu là đầu1 đầu2 đầu3");
                                                                        break;
                                                                    } else { //Nếu là số có 1 chữ số
                                                ...
                                                case "gheptrong":
                                                    ...
                                                    if (patternNumber.matcher(wordAfterGhepTrong).matches()) { //Nếu từ là số
                                                        if (!checkValidateRepeatChar(wordAfterGhepTrong)) {
                                                            isError = true;
                                                            setError(processEntity, childEntity, "Các số không được trùng nhau. Ví dụ: Đầu ĐB ghép trong 2345 x 10n");
                                                            break;
                                                        } else {
                                                            i += 1;
                                                        }
